...
```{r fig.align="center", fig.cap="Figure 4. Pairwise relationship between predictors"}
knitr::include_graphics("../src/maternal_risk_model_figures/hyperparam_plot.png")
```


- Table 3 is the confusion matrix which shows the prediction rate is consistently across all risk levels.
```{r confusion_matrix}
