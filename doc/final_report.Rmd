...
```{r}
corr_table<- read_csv("../src/maternal_risk_eda_figures/corr_plot.csv", show_col_types = FALSE)
corr_table
```

```{r figure3, echo=FALSE, out.width="100%"}
knitr::include_graphics("../src/maternal_risk_eda_figures/corr_plot.png")
fig.align="center"
...
knitr::include_graphics("../results/model_comparison_table.png")
```
...
#    kableExtra::kable_styling(position = "left", full_width = FALSE)
knitr::include_graphics("../results/testdata_confusion_matrix.png")
```
