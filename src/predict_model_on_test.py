...
'''Script which takes as input the best model (as a .pkl file) from hyperparameter optimization, as well as the test data. It computes the accuracy score of the model on the test data, as well as other metrics such as the confusion matrix. 
...
def main(bestmodel_path, test_df_path, output_dir_path):
    ...
    test_score_df = get_test_score(X_test, y_test, bestmodel_path)
